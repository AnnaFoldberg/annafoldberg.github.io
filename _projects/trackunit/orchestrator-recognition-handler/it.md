---
title: "Trackunit: Gestione delle analisi immagini completate - svc-analysis-orchestrator"
...
Questo esempio mostra come **svc-analysis-orchestrator** gestisce le analisi immagini completate. Consuma `tu.recognition.completed` tramite la queue `orchestrator.recognition-completed`, deserializza il payload e pubblica quindi un evento `AnalysisCompleted` sul fanout-exchange `analysis.completed`.
