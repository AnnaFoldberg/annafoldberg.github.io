---
title: "Trackunit: Håndtering af færdige billedanalyser - svc-analysis-orchestrator"
...
Dette eksempel viser, hvordan **svc-analysis-orchestrator** håndterer færdige billedanalyser. Den consumer `tu.recognition.completed` via queuen `orchestrator.recognition-completed`, deserialiserer payloaden og publicerer derefter et `AnalysisCompleted`-event til `analysis.completed` fanout-exchange.
